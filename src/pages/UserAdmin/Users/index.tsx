...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    {
      title: (
        <FormattedMessage id="pages.userAdmin.users.src.descLable" defaultMessage="用户来源" />
      ),
      dataIndex: 'desc',
      valueType: 'textarea',
    },
    ...
    },
    {
      title: (
        <FormattedMessage
          id="pages.userAdmin.users.lastLogin.descLable"
          defaultMessage="最近登录时间"
        />
      ),
      sorter: true,
      dataIndex: 'updatedAt',
    ...
    <PageContainer>
      <ProTable<API.RuleListItem, API.PageParams>
        headerTitle={intl.formatMessage({
          id: 'pages.userAdmin.users.title',
          defaultMessage: '学员例表',
        })}
        actionRef={actionRef}
        rowKey="key"
